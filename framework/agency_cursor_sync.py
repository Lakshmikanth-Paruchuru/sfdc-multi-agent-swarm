...
This repo uses an **Agency Swarm-style** layout from [Agency-Swarm](https://github.com/Lakshmikanth-Paruchuru/sfdc-multi-agent-swarm) — plain-English roles, CEO delegation, per-agent instructions.

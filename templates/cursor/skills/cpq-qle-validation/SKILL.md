...
- **Custom LWC quoting UIs** (org-specific editors that bypass Standard QLE) may not run the QCP and can flatten options to independent lines — don't conflate them with the Standard QLE. Confirm which tool the user means.

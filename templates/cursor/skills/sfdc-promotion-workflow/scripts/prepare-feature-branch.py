#!/usr/bin/env python3
"""Prepare your-promotion-repo feature branch with sandbox changes."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Prepare feature branch in your-promotion-repo")
